...
//       !documentFile
//     ) {
//       alert("⚠️ Please fill all required fields and upload document.");
//       return;
//     }
...
//               <Input label="DOB" type="date" required
//                 value={form.dob}
//                 onChange={(v) => setForm({ ...form, dob: v })}
//               />
...
//                 <label className="block text-sm text-gray-200 mb-1">
//                   Upload Document (Government / College ID) <span className="text-red-400">*</span>
//                 </label>
//                 <input
//                   type="file"
...
//         {/* Remaining Steps (2,3,4) stay EXACTLY SAME as your previous code */}
...
//             <div className="mt-6 flex justify-between">
//               <button onClick={() => setStep(1)} className="bg-slate-600 px-6 py-2 rounded">
//                 Back
//               </button>
//               <button onClick={() => setStep(3)} className="bg-blue-600 px-6 py-2 rounded">
//                 Next →
//               </button>
//             </div>
//           </>
...
//               <Input label="Grade"
//                 value={form.academic.grade}
//                 onChange={(v) =>
//                   setForm({ ...form, academic: { ...form.academic, grade: v } })
//                 }
//               />

//               <Input label="Percentage" required
...
//             <div className="mt-6 flex justify-between">
//               <button onClick={() => setStep(2)} className="bg-slate-600 px-6 py-2 rounded">
//                 Back
//               </button>
//               <button onClick={() => setStep(4)} className="bg-blue-600 px-6 py-2 rounded">
//                 Next →
//               </button>
//             </div>
//           </>
...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 text-white p-6">
      <div className="w-full max-w-5xl bg-slate-800 p-10 rounded-2xl shadow-2xl">
        ...
        {/* Remaining steps (2,3,4) remain logically identical — layout already modernized */}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Input
                ...
                onChange={(v) =>
                  setForm({
                    ...form,
                    academic: { ...form.academic, institution: v },
                  })
                }
              />
              <Input
                ...
                onChange={(v) =>
                  setForm({
                    ...form,
                    academic: { ...form.academic, degree: v },
                  })
                }
              />
              <Input
              ...
              <Input
                ...
                onChange={(v) =>
                  setForm({
                    ...form,
                    academic: { ...form.academic, percentage: v },
                  })
                }
              />
            </div>
        ...
        {step === 4 && (
          <>
            ...
            {form.works.map((work, index) => (
              <div
                key={index}
                className="grid md:grid-cols-2 gap-6 mb-8 border p-4 rounded-lg"
              >
                <Input
                  label="Company"
                  value={work.companyName}
